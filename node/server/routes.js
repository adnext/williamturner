...
module.exports = function(app, dbCli) {
	...
	// api ---------------------------------------------------------------------
   	app.get('/williamturner/api/turner/controller/TurnerController.php', function(req, res) {
	...
	app.post('/williamturner/api/turner/controller/TurnerController.php', function(req, res) {
	...
	app.delete('/williamturner/api/turner/controller/TurnerController.php/:id', function(req, res) {
